        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-8 lg:gap-12">
          ...
          <div className="lg:col-span-5 space-y-4">
            <div className="flex items-center space-x-3 cursor-pointer" onClick={(e) => handleLinkClick(e, 'home')}>
              ...
              />
              <div>
                <span className="text-amber-105 font-serif font-bold text-xs sm:text-sm tracking-wide block">
            ...
            <div className="text-[10px] bg-amber-900/60 p-3 rounded-lg border border-amber-800/40 divide-y divide-amber-800/20 space-y-1.5 max-w-md font-mono text-stone-300">
              <p>✔ Central Registration ID: <strong className="text-white"></strong></p>
              <p className="pt-1.5">✔ 80G Order Number: <span className="text-orange-400"></span></p>
              <p className="pt-1.5">✔ FCRA Registration Code: <span className="text-orange-400"></span></p>
            </div>
          </div>
          ...
          <div className="lg:col-span-4 space-y-4">
            ...
            <p className="text-stone-300 text-xs leading-relaxed">
              {/* Kept blank - Under Construction */}
            </p>
            
            <div className="space-y-1.5 pt-1 text-xs">
              <p className="text-stone-400">Phone: <strong className="text-stone-150 font-mono"></strong></p>
              <p className="text-stone-400">Alternate: <span className="font-mono"></span></p>
              <p className="text-stone-400">Email: <span className="text-orange-400 font-bold"></span></p>
      ...
      <div className="bg-amber-955 py-6 text-center text-[10px] text-stone-400 font-mono border-t border-amber-900/50 relative z-10 px-4">
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row justify-between items-center gap-4">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-3 text-[11px]" id="compliance_info_footer_section">
            <div className="flex items-center gap-2.5 bg-amber-950/60 border border-amber-500/30 px-3 py-1.5 rounded-lg shrink-0" id="amber_status_badge">
              <span className="relative flex h-2 w-2">
                <span className="animate-ping absolute inline-flex h-full w-full rounded-full bg-amber-400 opacity-75"></span>
                <span className="relative inline-flex rounded-full h-2 w-2 bg-amber-500"></span>
              </span>
              <span className="text-amber-400 font-bold uppercase tracking-wider text-[10px]">Under Construction</span>
            </div>
            <p className="text-stone-400 text-xs text-center md:text-left" id="compliance_text_p">
              Statutory verification ledgers, audited compliance logs, and tax exemption certification assets are currently undergoing routine archiving and are under construction.
            </p>
          </div>

          <div className="text-xs text-stone-300 font-sans md:text-right" id="copyright_info_footer">
            &copy; {currentYear} Kalavapudi Krishnamacharyulu Memorial Charitable and Dharma Trust. Srimathe Ramanujaya Namaha. System Compliance Under Construction.
          </div>
