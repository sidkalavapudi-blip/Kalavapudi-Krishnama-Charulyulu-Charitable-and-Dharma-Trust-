      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center max-w-3xl mx-auto mb-16" id="contact_header">
          ...
          <div className="inline-flex items-center gap-2 bg-amber-50 border border-amber-200/80 px-4 py-1.5 rounded-full mb-4 shadow-xs">
            ...
            <span className="text-[10px] text-amber-900 font-bold uppercase tracking-wider">Contact Communication Hub Under Construction</span>
          </div>
          ...
          <div className="lg:col-span-5 space-y-6" id="contact_details_column">
            ...
            <div className="flex items-start space-x-4 bg-amber-50/40 p-5 rounded-xl border border-amber-100/50">
              ...
              <div className="w-full">
                <h4 className="text-xs font-bold text-amber-955 uppercase tracking-widest">Telephone & WhatsApp</h4>
                <div className="mt-1 flex flex-col space-y-1 text-xs sm:text-sm text-stone-700 font-mono">
                  <span className="font-sans font-bold"></span>
                  <span className="font-sans text-stone-500"></span>
                </div>
              </div>
            </div>
            ...
            <div className="flex items-start space-x-4 bg-amber-50/40 p-5 rounded-xl border border-amber-100/50">
              ...
              <div>
                ...
                <div className="mt-1 flex flex-col space-y-1 text-xs sm:text-sm text-stone-700 font-mono">
                  <span className="font-sans font-bold text-orange-700"></span>
                  <span className="font-sans text-stone-500"></span>
                </div>
              </div>
            </div>
          ...
          <div className="lg:col-span-7 bg-white p-6 sm:p-8 rounded-2xl border border-amber-150/50 shadow-xl" id="contact_form_column">
            ...
            <form onSubmit={handleFormSubmit} className="space-y-5">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div>
                  <label className="text-xs font-bold text-amber-955 block mb-1 uppercase">Full Name <span className="text-red-500 font-sans">*</span></label>
                  <input
                    type="text"
                    name="name"
                    value={formData.name}
                ...
                <div>
                  <label className="text-xs font-bold text-amber-955 block mb-1 uppercase">Email Address <span className="text-red-500 font-sans">*</span></label>
                  <input
                    type="email"
                    name="email"
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div>
                  <label className="text-xs font-bold text-amber-955 block mb-1 uppercase">WhatsApp Phone <span className="text-red-500 font-sans">*</span></label>
                  <input
                    type="text"
                    name="phone"
                ...
                <div>
                  <label className="text-xs font-bold text-amber-955 block mb-1 uppercase">Inquiry Topic</label>
                  <select
                    name="subject"
                    value={formData.subject}
                    onChange={handleInputChange}
                    className="w-full px-4 py-2.5 bg-stone-50 border border-stone-200 rounded-lg text-xs font-bold text-stone-904 focus:ring-2 focus:ring-orange-500 focus:outline-hidden"
                  >
              ...
              <div>
                <label className="text-xs font-bold text-amber-955 block mb-1 uppercase">Your Detailed message <span className="text-red-500 font-sans">*</span></label>
                <textarea
                  rows={4}
                  name="message"
