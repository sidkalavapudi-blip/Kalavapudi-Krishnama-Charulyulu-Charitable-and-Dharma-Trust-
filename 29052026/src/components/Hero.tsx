...
import { ShieldCheck, HeartHandshake, HelpCircle, ArrowRight, Landmark, X } from 'lucide-react';
...
export default function Hero({ onNavigate }: HeroProps) {
  ...
  return (
    <div id="home" className="relative pt-18 overflow-hidden bg-amber-50">
      ...
      <div className="absolute bottom-20 left-0 w-80 h-80 bg-yellow-100/20 rounded-full blur-3xl pointer-events-none" />

      {/* Main Banner Block */}
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-6 pb-12 lg:pt-12 lg:pb-16 flex flex-col items-center">
        
        {/* Top Digital Archive Greeting Notice Banner */}
        <AnimatePresence>
          {showHeroBanner && (
            <motion.div
              ...
              className="w-full bg-amber-100/60 border border-amber-300/40 rounded-2xl p-4 mb-6 flex flex-col sm:flex-row items-center justify-between gap-4 shadow-xs relative overflow-hidden"
              id="website_under_construction_top_banner"
            >
              <div className="flex items-start gap-3">
                ...
                <div className="text-left text-xs sm:text-sm">
                  <p className="font-serif font-black text-amber-950 uppercase tracking-widest">Trust Digital Portal Active</p>
                  <p className="text-stone-600 text-xs mt-0.5 leading-relaxed">
                    Welcome to the official legal portal of K. Krishnamacharyulu Trust. Review our visual restorations, temple restoration ledgers, and try our automated 80G billing desk.
                  </p>
                </div>
              </div>
              <div className="flex items-center gap-3 shrink-0">
                <span className="text-[10px] font-mono font-bold uppercase bg-orange-100 text-orange-850 px-2.5 py-1 rounded-md border border-orange-200">
                  Archival Phase 1 Online
                </span>
                <button
                  type="button"
                  onClick={() => setShowHeroBanner(false)}
                  className="p-1 text-stone-400 hover:text-stone-750 hover:bg-stone-100/50 cursor-pointer rounded-full transition-colors"
        ...
        <div className="relative w-full rounded-2xl overflow-hidden shadow-2xl border-2 border-amber-200/50 min-h-[480px] lg:min-h-[520px] flex flex-col justify-end p-6 sm:p-10 lg:p-12 mb-12">
          ...
          <div className="absolute inset-0 z-0">
            <img
              src="/src/assets/images/temple_hero_banner_1780058391675.png"
              alt="Magnificent Temple Gopuram at Sunrise"
              className="w-full h-full object-cover object-center md:object-[center_35%] select-none scale-105 hover:scale-100 transition-transform duration-10000 ease-out"
          ...
          <div className="relative z-10 max-w-3xl text-left" id="hero_header_content">
            ...
            >
              ...
              <span>Registered 2026 | 80G & FCRA Compliant</span>
            </motion.div>
            ...
            >
              To honour the legacy of Late Professor Kalavapudi Krishnamacharyulu by supporting temples in and around Visakhapatnam that require immediate attention
            </motion.p>
            ...
            >
              ...
              >
                ...
                <span>Learn Our Trust's Work</span>
              </button>
            </motion.div>
          </div>
        </div>
